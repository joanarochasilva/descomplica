...
const ListarTarefa = () => {
  ...
  const handleDeletar = (id) => {
    ...
    <Card>
                ...
                {tarefas.map((row, indice) => (
                    ...
                    >
                      ...
                      <TableCell align="center">
                        <Button variant="text" color="secondary" onClick={() => handleEditar(row.idTarefa)}><EditIcon fontSize="large" /></Button>            
                      </TableCell>
                      <TableCell align="center">
                        <Button variant="text" color="warning" onClick={() => handleDeletar(row.idTarefa)}><DeleteIcon fontSize="large" /></Button>            
                      </TableCell>
                    </TableRow>
                ))}
                </TableBody>
        ...
        <CardActions>
            <Button size="large" color= "success" variant="contained" onClick={handleOpen}>Criar Tarefa</Button>
            <Button size="large" variant="outlined" color= "secondary">Cancelar</Button>
      </CardActions> 
    </Card>
    <div>
      <Modal
